...
import { SuggestionsList } from 'components/Dashboard/suggestions/styles'
...
const connectedSuggestions = connect(mapStateToProps, null)(Suggestions)

export default withData(withMaterial(graphql(SuggestionsQuery, {
    options: {
        variables: {
