...
const WinRateChart = ({ fsWinRate, marketWinRate, planName, theme }) => (
    <div>
        <ChartBeside>
            <Chart color={theme.colors.primary} height={fsWinRate}><WinRate>{fsWinRate}%</WinRate><ChartName>{planName}</ChartName></Chart>
            <Chart color={theme.colors.black} height={marketWinRate}><WinRate>{marketWinRate}%</WinRate><ChartName>Market</ChartName></Chart>
        </ChartBeside>
